...
export default function StudentList() {
  ...
  // This will hold the temporary state new majors being aded
          ...
          <section className="student-list">
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => {
                          ...
                          // the students array is updated with the student with matching id filtered out
                          return dispatch({
                            type: REMOVE_STUDENT,
                            payload: student.id,
                          });
            ...
            <div className="add-student">
              ...
              >
                ...
                {/* the state will be updated and the major will appear as an option */}
            ...
            <div className="add-major">
              ...
              {/* This sets a local state to be used below*/}
              <input
                value={newMajorName}
              ...
              <button
                ...
                onClick={() => {
                  ...
                  // the state.majors array is updated with the newMajorName
                  return dispatch({
                    type: ADD_MAJOR,
